...
export default function ContactPage() {
  ...
  const address =
    "Changwon National University, Changwon, Republic of Korea (50호관 105호)";

  const googleMapLink =
    "https://www.google.com/maps/search/?api=1&query=창원대학교+공대실험1동";
  const googleMapEmbed =
    "https://www.google.com/maps?q=창원대학교+공대실험1동&output=embed";
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 relative overflow-hidden h-full">
              ...
              <div className="relative">
                <p className="text-sm text-white/70 leading-relaxed">
                  대학원/학부 연구생 모집, 연구 협력 및 산업체 프로젝트 관련 문의는
                  연구책임자(PI)에게 문의 바랍니다.
                </p>
